...
print("Середня квадратична помилка =", round(sm.mean_squared_error(y_test, y_test_pred), 2))
print("Середня абсолютна помилка =", round(sm.median_absolute_error(y_test, y_test_pred), 2))
print("Пояснена оцінка дисперсії =", round(sm.explained_variance_score(y_test, y_test_pred), 2))
